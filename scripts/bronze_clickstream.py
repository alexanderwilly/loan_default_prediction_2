...
def main():
    print('\n\n--- starting job ~ bronze_clickstream ---\n\n')
    ...
    for date_str in dates_str_lst:
        utils.data_processing_bronze_table.process_bronze_table('clickstream', 'data/feature_clickstream.csv', bronze_directory, date_str, spark)
    

    # end spark session
    spark.stop()
    print('\n\n--- finished job ~ bronze_clickstream ---\n\n')
