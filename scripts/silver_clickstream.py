...
def main():
    print('\n\n--- starting job ~ silver_clickstream ---\n\n')
    ...
    for date_str in dates_str_lst:
        utils.data_processing_silver_table.process_silver_table('clickstream', bronze_directory, silver_directory, date_str, spark)



    # end spark session
    spark.stop()
    print('\n\n--- finished job ~ silver_clickstream ---\n\n')
